...
If you deploy from this repository directly, do not serve the root source files (`index.html` imports `/src/main.jsx`).
Build first and publish the compiled output in `docs/`:
...
This prevents browser MIME errors for module scripts.
